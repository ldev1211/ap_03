                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: TextField(
                          onSubmitted: (stringSearch){
                            showDialog(context: context, builder: (BuildContext context) => SearchResultDialog(_textSearchController.text,"listen"));
                          },
                      ...
                      InkWell(
                        ...
                        child: ClipRRect(
                            ...
                            items: listLinkBanner.map((e) => Image(image: NetworkImage(e!.banner!),width: double.infinity,fit: BoxFit.fill,)).toList(),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ClipRRect(
                                      ...
                                      child: Image(image: NetworkImage(listTop100[index]!.items![0]!.thumbnail!)),
                                    ),
                              ...
                              return Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ClipRRect(
                                      borderRadius: BorderRadius.circular(12),
                                      child: Image(image: NetworkImage(listHotArtist[index]!.thumbnail!)),
                                    ),
                                    const Padding(padding: EdgeInsets.only(top: 4)),
                                    Flexible(
                                      child: Text(
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    ClipRRect(
                                      borderRadius: const BorderRadius.all(Radius.circular(12)),
                                      child: Image(image: NetworkImage(listSongChart[index]!.thumbnailM!)),
                                    ),
                                    const Padding(padding: EdgeInsets.only(right: 8)),
                                    Flexible(
                                      child: Column(
