            ...
            children: [
              ...
              Expanded(
                child: PageView(
                  ...
                  children: const [HomePage(), NewReleasePage(), KaraokePage()],
                ),
              )
            ],
          ),
                      ...
                      children: [
                        ...
                        BlocBuilder<PlayMusicBloc, PlayMusicState>(
                          ...
                          return curr is PlaySongState ||
                              curr is PauseSongState ||
                              curr is ResumeSongState;
                        }, builder: (context, state) {
                              ...
                              child: Row(children: [
                                ClipRRect(
                                  borderRadius: const BorderRadius.all(
                                      Radius.circular(12)),
                                  child: Image(
                                      image: NetworkImage((state).linkThumb)),
                                ),
                                const Padding(
                        ...
                        BlocBuilder<PlayMusicBloc, PlayMusicState>(
                            buildWhen: (prev, curr) {
                          return curr is SeekState ||
                              curr is PlaySongState ||
                              curr is AudioPositionChangeState;
                        }, builder: (context, state) {
                          if (state is PlaySongState) {
                            return Row(
                                crossAxisAlignment: CrossAxisAlignment.center,
                                ...
                                if (state is DownloadSongState) {
                                  return InkWell(
                                    ...
                                    child: Container(
                                      ...
                                      child: (!state.isDownloadedFinish)
