...
class SearchResultDialog extends StatefulWidget {
  ...
  const SearchResultDialog(this.textSearch,this.action,{Key? key}) : super(key: key);
                    ...
                    itemBuilder: (context,index){
                      return InkWell(
                        onTap: () async {
                          ...
                          BlocProvider.of<PlayMusicBloc>(context).add((widget.action =="listen")?PlaySongEvent(
                              id,
                              (response.data.quality320=="VIP")?"320":"128",
                              songs[index].title!,
                          ...
                          child: Row(
                            ...
                            children: [
                              ClipRRect(
                                ...
                                child: Image(image: NetworkImage(songs[index].thumbnailM!)),
                              ),
