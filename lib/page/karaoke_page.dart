    ...
    return Scaffold(
      ...
      child: Column(
        ...
        children: [
          GestureDetector(
            onTap: () {
              MainPageProvider.musicBloc.add(EndKaraokeEvent());
            },
            child: const Text(
              "Karaoke",
              style: TextStyle(
              ...
              onSubmitted: (stringSearch) {
                showDialog(
                    ...
                    builder: (BuildContext context) =>
                        SearchResultDialog(_textSearchController.text, "kara"));
              },
                ...
                if (stateKaraoke.sentences.isNotEmpty) {
                  return ScrollablePositionedList.builder(
                    ...
                    itemBuilder: (context, index) {
                      String sentence = "";
                      for (int i = 0;
                          i < stateKaraoke.sentences[index].words.length;
                          ++i) {
                        sentence +=
                            "${stateKaraoke.sentences[index].words[i].data} ";
                      }
                      ...
                      return BlocBuilder<PlayMusicBloc, PlayMusicState>(
                        ...
                        if (stateLyricChange is KaraokeChangeLyricState) {
                          List<Word> words =
                              stateKaraoke.sentences[index].words;
                          _scrollController.scrollTo(
                              index: stateLyricChange.indexScroll,
                            ...
                            child: Row(
                              ...
                              children: [
                                Flexible(
                                  ...
                                  sentence,
                                  style: TextStyle(
                                      color: (stateLyricChange
                                                  .currDuration.inMilliseconds >
                                              words[0].startTime)
                                          ? Colors.red
                                          : Colors.grey,
                                      fontSize: (stateLyricChange
                                                  .currDuration.inMilliseconds >
                                              words[0].startTime)
                                          ? 20
                                          : 15,
                  ...
                  return const Center(
                      child: Text(
                    "Rất tiếc! Bài hát này không có lyric",
